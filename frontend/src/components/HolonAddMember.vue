  ...
  >
    ...
    >
      <form v-show="showAddField" class="w-full max-w-sm">
        ...
        >
          <input
            class="appearance-none bg-transparent border-none w-full text-black mr-3 py-1 px-5 leading-tight placeholder-black focus:outline-none"
            type="text"
            placeholder="address"
            v-model="address"
      ...
      <span v-show="!showAddField"> add member </span>
    </div>
  </div>
</template>
